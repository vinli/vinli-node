...
module.exports = function(client) {
  ...
  Vehicle.prototype.odometers = function(_options) {
    ...
    return client.get(
      ...
      _options).then(function(resp) {
        ...
        return Utils.listResponse(resp, 'odometers', self.odometers, self);
      });
  };
  ...
  Vehicle.prototype.odometerTriggers = function(_options) {
    ...
    return client.get(
      ...
      _options).then(function(resp) {
        ...
        return Utils.listResponse(resp, 'odometerTriggers', self.odometerTriggers, self);
      });
  };
  ...
  Vehicle.prototype.distances = function(_options) {
    ...
    if (_options.unit === 'km' || _options.unit === 'mi' || _options.unit === 'm') {
