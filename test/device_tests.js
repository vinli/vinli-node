...
describe('Device', function() {
  ...
  describe('#subscriptions()', function() {
    it('should exist', function() {
      var device = Vinli.Device.forge('asfdafdasfdsdf');
      expect(device).to.have.property('subscriptions').that.is.a('function');
    });

    it('should return a list of subscriptions for the devices', function() {
        ...
        .reply(200, {
          ...
          meta: {
            pagination: {
              ...
              offset: 0,
              links: {
                first: 'https://events.vin.li/api/v1/devices/c92fa3e1-3837-4def-aa11-fabf9f00440e/subscriptions?offset=0&limit=20',
                last: 'https://events.vin.li/api/v1/devices/c92fa3e1-3837-4def-aa11-fabf9f00440e/subscriptions?offset=0&limit=20'
              }
            }
          }
        });
      ...
      return Vinli.Device.forge('c92fa3e1-3837-4def-aa11-fabf9f00440e').subscriptions({ limit: 2 })
        .then(function(subscriptions) {
          ...
          expect(subscriptions).to.have.property('first').that.is.a('function');
